...
class Config:
    API_ID = int(os.getenv("API_ID", "21200698"))
    API_HASH = os.getenv("API_HASH", "e0d3c29dff9b449d710b1d6516be8673")
    BOT_TOKEN = os.getenv("BOT_TOKEN", "7619169950:AAG_mY4wz_ndGky1MOvtZLYjnD39FoydkJc")
